...
> 写在前面：本专题不讨论"AI 还有哪些想象空间"，只讨论"为什么我们以为会成功、最后却砸了"。所有内容基于行业公开现象（公开复盘、技术博客、监管通报、财报披露、学术论文复现实验）综合提炼，不杜撰任何未公开的公司机密。案例描述以"现象—根因—教训—防范"四段式呈现，目的是让 <abbr class="term" title="前沿部署工程师;把 AI/数据系统部署到客户真实环境并对业务结果负责">FDE</abbr> 在下一次进现场前，先认得这些坑。
